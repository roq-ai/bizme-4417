...
import { getJobOpportunityById } from 'apiSdk/job-opportunities';
...
function JobOpportunityViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Job Opportunity Detail View
          </Text>
          {hasAccess('job_opportunity', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/job-opportunities/edit/${data?.id}`} passHref legacyBehavior>
              <Button
              ...
              {hasAccess('application', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/applications/create?job_opportunity_id=${data?.id}`}>
